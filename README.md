...
1. **Surface the tensions** that arise at the boundary of what formal reasoning can and cannot resolve. For instance, climate mitigation offers diffuse, global benefits while imposing concentrated costs on identifiable groups. Layered on this are problems of intergenerational fairness and international equity. Fundamentally, these are normative questions.  The symposium is designed to surface these tensions and probe the limits of autonomous planning by inviting climate policy researchers and social scientists into the conversation as essential partners rather than observers.
